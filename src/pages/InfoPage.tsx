        ...
        <div className="info-page">
            <Container size="md" className="py-20">
                ...
                <Text className="mb-8 text-lg">
                    Here's some useful information about our project and
                    services.
                </Text>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <Card withBorder shadow="sm" radius="md">
                        ...
                        <Text size="sm">
                            Vite provides instant server start and
                    ...
                    <Card withBorder shadow="sm" radius="md">
                        ...
                        <Text size="sm">
                            TypeScript ensures type safety and provides
                    ...
                    <Card withBorder shadow="sm" radius="md">
                        ...
                        <Text size="sm">
                            Mantine provides a comprehensive component library
                            for building polished interfaces.
                        </Text>
                    </Card>
                    ...
                    <Card withBorder shadow="sm" radius="md">
                        ...
                        <Text size="sm">
                            Tailwind CSS makes it simple to create custom
