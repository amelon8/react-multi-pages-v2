        ...
        <div className="home-page">
            <Container size="md" className="py-20">
                ...
                <Text className="mb-8 text-lg">
                    This is the home page of our multi-page React application
                    built with Vite, React Router, Mantine UI, and Tailwind CSS.
                </Text>

                <div className="mb-8 mt-12 p-8 bg-blue-50 rounded-lg">
                    <Title order={3} className="mb-4">Getting Started</Title>
                    <Text>
                        Navigate through the pages using the links above to
